...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   calculateNextState: () => (/* binding */ calculateNextState),\n/* harmony export */   generateGrid: () => (/* binding */ generateGrid)\n/* harmony export */ });\nfunction generateCell(x, y) {\n    var cell = document.createElement(\"div\");\n    cell.classList.add(\"cell\");\n    cell.id = \"cell-\".concat(x, \"-\").concat(y);\n    cell.dataset.x = String(x);\n    cell.dataset.y = String(y);\n    if (Math.random() < 0.1) {\n        cell.dataset.alive = \"true\";\n    }\n    else {\n        cell.dataset.alive = \"false\";\n    }\n    return cell;\n}\nfunction getNeibours(cell) {\n    var x = parseInt(cell.dataset.x);\n    var y = parseInt(cell.dataset.y);\n    var neibours = [];\n    for (var i = x - 1; i <= x + 1; i++) {\n        for (var j = y - 1; j <= y + 1; j++) {\n            if (i === x && j === y) {\n                continue;\n            }\n            var neibour = document.getElementById(\"cell-\".concat(i, \"-\").concat(j));\n            if (neibour) {\n                neibours.push(neibour);\n            }\n        }\n    }\n    neibours = neibours.filter(function (neibour) { return neibour.dataset.alive === \"true\"; });\n    return neibours;\n}\nfunction updateCell(cell) {\n    if (cell.dataset.alive === \"true\") {\n        cell.classList.add(\"alive\");\n    }\n    else {\n        cell.classList.remove(\"alive\");\n    }\n}\nfunction generateGrid(rows, cols) {\n    var grid = document.createElement(\"div\");\n    grid.classList.add(\"grid\");\n    grid.style.gridTemplateColumns = \"repeat(\".concat(cols, \", 1fr)\");\n    grid.style.gridTemplateRows = \"repeat(\".concat(rows, \", 1fr)\");\n    for (var i = 0; i < rows; i++) {\n        for (var j = 0; j < cols; j++) {\n            grid.appendChild(generateCell(i, j));\n        }\n    }\n    for (var i = 0; i < rows; i++) {\n        for (var j = 0; j < cols; j++) {\n            updateCell(grid.children[i * cols + j]);\n        }\n    }\n    return grid;\n}\nfunction calculateNextState(grid) {\n    var cells = grid.querySelectorAll(\".cell\");\n    for (var i = 0; i < cells.length; i++) {\n        var cell = cells[i];\n        var neibours = getNeibours(cell);\n        if (neibours.length < 2 || neibours.length > 3) {\n            cell.dataset.alive = \"false\";\n        }\n        else if (neibours.length === 3) {\n            cell.dataset.alive = \"true\";\n        }\n    }\n    for (var i = 0; i < cells.length; i++) {\n        var cell = cells[i];\n        updateCell(cell);\n    }\n}\n\n\n//# sourceURL=webpack://my-webpack-project/./src/components.ts?");
